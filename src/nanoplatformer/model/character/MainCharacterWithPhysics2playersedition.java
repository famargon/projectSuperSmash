 ...
 * @author Nestor
 */
public class MainCharacterWithPhysics2playersedition {
    ...
    public MainCharacterWithPhysics2playersedition(int id,int positionX, int positionY, ImageInfo graphicInfo) {
